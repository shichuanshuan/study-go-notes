...
func (this *UserProcess) Register(userId int, userPwd string) (err error) {
	// 1. 链接到服务器
	...
	if err != nil {
		fmt.Println("json.Marsharl err=", err)
		return
	}

	// 5. 把data 赋给 mes.Data 字段
...
func (this *UserProcess) Login(userId int, userPwd string) (err error) {
	...
	fmt.Println("客户端，发送消息的长度", pkgLen)

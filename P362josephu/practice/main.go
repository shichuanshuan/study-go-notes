...
// func AddBoy(first *Boy, num int) *Boy {
// 	helper := first
// 	for i := 1; i <= num; i++ {
// 		boy := &Boy{
// 			no: i,
...
// func PlayGame(first *Boy, start int, counter int) {
// 	temp := first
// 	helper := first
// 	if first.next == nil {
// 		return
...
// 			helper = helper.next
// 		}
// 		fmt.Println("Pop boy is", temp.no)
// 		temp = temp.next
// 		helper.next = temp
...
// 	}
// 	fmt.Println("2 Pop boy is", temp.no)
// }

// func main() {
// 	first := &Boy{}
// 	first = AddBoy(first, 5)
// 	Show(first)
